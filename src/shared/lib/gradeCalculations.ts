...
/**
 * Calculates detailed statistics from a list of manual grades.
 * Centralizes logic found in GradeOverview and GradeAnalytics.
 */
export const calculateGradeStats = (grades: ManualGrade[]): GradeStats => {
  ...
  grades.forEach((g) => {
    // Normalize subject name if needed, but for now assuming strict exact matches or relying on UI consistency
