...
export const SJTStage: React.FC = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col overflow-hidden relative font-outfit">
      ...
      <div className="relative z-10 h-full overflow-y-auto p-6 max-w-4xl mx-auto custom-scrollbar">
        ...
        <div className="bg-[#0A0A0B] border border-white/10 rounded-3xl p-8 mb-8 relative overflow-hidden backdrop-blur-sm">
