...
export const StereoTrainer: React.FC<{
  ...
  const switchMode = (newMode: GameMode) => {
    ...
    navigate(`/3d-studio/stereo/${path}`);
  };
                ...
                {userMolecules.length > 0 ? (
                  <div className="grid grid-cols-2 gap-2 max-h-40 overflow-y-auto pr-2 custom-scrollbar">
                    <button
                      ...
                      className={`p-3 rounded-xl border text-xs text-center transition-all font-medium ${
                    ...
                    {userMolecules.map((m) => (
                      <button
                        ...
                        className={`p-3 rounded-xl border text-xs truncate transition-all font-medium ${
                          selectedUserMolecule?.name === m.name
          ...
          <div className="flex-1 flex flex-col lg:flex-row relative">
            ...
            <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-px bg-white/5">
              ...
              <div className="relative group bg-obsidian-900/50 flex-1 min-h-0">
                ...
                {question && canvasReady && container && (
                  <Canvas
